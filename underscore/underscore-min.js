...
((function(...args) {
  ...
  "undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=j),exports._=j):n._=j,j.VERSION="1.5.2";var A=j.each=j.forEach=(n, t, e) => {if(null!=n)if(s&&n.forEach===s)n.forEach(t,e);else if(n.length===+n.length){for(var u=0,i=n.length;i>u;u++)if(t.call(e,n[u],u,n)===r)return}else for(var a=j.keys(n),u=0,i=a.length;i>u;u++)if(t.call(e,n[a[u]],a[u],n)===r)return};j.map=j.collect=(n, t, r) => {var e=[];return null==n?e:p&&n.map===p?n.map(t,r):(A(n,(n, u, i) => {e.push(t.call(r,n,u,i))}),e);};var E="Reduce of empty array with no initial value";j.reduce=j.foldl=j.inject=function(n,t,r,e){var u=arguments.length>2;if(null==n&&(n=[]),h&&n.reduce===h)return e&&(t=j.bind(t,e)),u?n.reduce(t,r):n.reduce(t);if(A(n,(n, i, a) => {u?r=t.call(e,r,n,i,a):(r=n,u=!0)}),!u)throw new TypeError(E);return r},j.reduceRight=j.foldr=function(n,t,r,e){var u=arguments.length>2;if(null==n&&(n=[]),v&&n.reduceRight===v)return e&&(t=j.bind(t,e)),u?n.reduceRight(t,r):n.reduceRight(t);var i=n.length;if(i!==+i){var a=j.keys(n);i=a.length}if(A(n,(o, c, l) => {c=a?a[--i]:--i,u?r=t.call(e,r,n[c],c,l):(r=n[c],u=!0)}),!u)throw new TypeError(E);return r},j.find=j.detect=(n, t, r) => {var e;return O(n,(n, u, i) => t.call(r,n,u,i)?(e=n,!0):void 0),e;},j.filter=j.select=(n, t, r) => {var e=[];return null==n?e:g&&n.filter===g?n.filter(t,r):(A(n,(n, u, i) => {t.call(r,n,u,i)&&e.push(n)}),e);},j.reject=(n, t, r) => j.filter(n,(n, e, u) => !t.call(r,n,e,u),r),j.every=j.all=(n, t, e) => {t||(t=j.identity);var u=!0;return null==n?u:d&&n.every===d?n.every(t,e):(A(n,(n, i, a) => (u=u&&t.call(e,n,i,a))?void 0:r),!!u);};var O=j.some=j.any=(n, t, e) => {t||(t=j.identity);var u=!1;return null==n?u:m&&n.some===m?n.some(t,e):(A(n,(n, i, a) => u||(u=t.call(e,n,i,a))?r:void 0),!!u);};j.contains=j.include=(n, t) => null==n?!1:y&&n.indexOf===y?n.indexOf(t)!=-1:O(n,n => n===t),j.invoke=function(n,t){
  ...
  },j.sample=function(n,t,r){return arguments.length<2||r?n[j.random(n.length-1)]:j.shuffle(n).slice(0,Math.max(0,t))};var k=n => j.isFunction(n)?n:t => t[n];j.sortBy=(n, t, r) => {var e=k(t);return j.pluck(j.map(n,(n, t, u) => ({
    value:n,
    index:t,
    ...
    var u={};
    var i=null==r?j.identity:k(r);
    return A(t,(r, a) => {var o=i.call(e,r,a,t);n(u,o,r)}),u;
  };j.groupBy=F((n, t, r) => {(j.has(n,t)?n[t]:n[t]=[]).push(r)}),j.indexBy=F((n, t, r) => {n[t]=r}),j.countBy=F((n, t) => {j.has(n,t)?n[t]++:n[t]=1}),j.sortedIndex=(n, t, r, e) => {r=null==r?j.identity:k(r);for(var u=r.call(e,t),i=0,a=n.length;a>i;){var o=i+a>>>1;r.call(e,n[o])<u?i=o+1:a=o}return i},j.toArray=n => n?j.isArray(n)?o.call(n):n.length===+n.length?j.map(n,j.identity):j.values(n):[],j.size=n => null==n?0:n.length===+n.length?n.length:j.keys(n).length,j.first=j.head=j.take=(n, t, r) => null==n?void 0:null==t||r?n[0]:o.call(n,0,t),j.initial=(n, t, r) => o.call(n,0,n.length-(null==t||r?1:t)),j.last=(n, t, r) => null==n?void 0:null==t||r?n[n.length-1]:o.call(n,Math.max(n.length-t,0)),j.rest=j.tail=j.drop=(n, t, r) => o.call(n,null==t||r?1:t),j.compact=n => j.filter(n,j.identity);var M=(n, t, r) => t&&j.every(n,j.isArray)?c.apply(r,n):(A(n,n => {j.isArray(n)||j.isArguments(n)?t?a.apply(r,n):M(n,t,r):r.push(n)}),r);j.flatten=(n, t) => M(n,t,[]),j.without=function(n){return j.difference(n,o.call(arguments,1))},j.uniq=j.unique=(n, t, r, e) => {
  ...
  },j.lastIndexOf=(n, t, r) => {if(null==n)return-1;var e=null!=r;if(b&&n.lastIndexOf===b)return e?n.lastIndexOf(t,r):n.lastIndexOf(t);for(var u=e?r:n.length;u--;)if(n[u]===t)return u;return-1},j.range=function(n,t,r){arguments.length<=1&&(t=n||0,n=0),r=arguments[2]||1;for(var e=Math.max(Math.ceil((t-n)/r),0),u=0,i=new Array(e);e>u;)i[u++]=n,n+=r;return i};var R=() => {};j.bind=function(n,t){
    var r;
    var e;
    if(_&&n.bind===_)return _.apply(n,o.call(arguments,1));if(!j.isFunction(n))throw new TypeError;return r=o.call(arguments,2),e=function(...args) {if(!(this instanceof e))return n.apply(t,r.concat(o.call(args)));R.prototype=n.prototype;var u=new R;R.prototype=null;var i=n.apply(u,r.concat(o.call(args)));return Object(i)===i?i:u};
    ...
    return function(...args) {
      i=this,u=args,a=new Date;
      var c=() => {var l=new Date-a;t>l?e=setTimeout(c,t-l):(e=null,r||(o=n.apply(i,u)))};
      var l=r&&!e;
  ...
  },j.wrap=(n, t) => function(...args) {var r=[n];return a.apply(r,args),t.apply(this,r);},j.compose=function(...args) {var n=args;return function(...args) {for(var t=args,r=n.length-1;r>=0;r--)t=[n[r].apply(this,t)];return t[0]};},j.after=(n, t) => function(...args) {return --n<1?t.apply(this,args):void 0;},j.keys=w||(n => {if(n!==Object(n))throw new TypeError("Invalid object");var t=[];for(var r in n)j.has(n,r)&&t.push(r);return t}),j.values=n => {for(var t=j.keys(n),r=t.length,e=new Array(r),u=0;r>u;u++)e[u]=n[t[u]];return e},j.pairs=n => {for(var t=j.keys(n),r=t.length,e=new Array(r),u=0;r>u;u++)e[u]=[t[u],n[t[u]]];return e},j.invert=n => {for(var t={},r=j.keys(n),e=0,u=r.length;u>e;e++)t[n[r[e]]]=r[e];return t},j.functions=j.methods=n => {var t=[];for(var r in n)j.isFunction(n[r])&&t.push(r);return t.sort()},j.extend=function(n){return A(o.call(arguments,1),t => {if(t)for(var r in t)n[r]=t[r]}),n;},j.pick=function(n){
    var t={};
