...
(((window, undefined) => {
    ...
    var // List of deleted data cache ids, so we can reuse them
    core_deletedIds = [];
    ...
    (((window, undefined) => {
        ...
        var // General-purpose constants
        strundefined = typeof undefined;

        var MAX_NEGATIVE = 1 << 31;

        var // Instance methods
        ...
        var // Use a stripped-down indexOf if we can't use a native one
        ...
        var // CSS escapes http://www.w3.org/TR/CSS21/syndata.html#escaped-characters
        runescape = new RegExp( "\\\\([\\da-f]{1,6}" + whitespace + "?|(" + whitespace + ")|.)", "ig" );

        var funescape = (_, escaped, escapedWhitespace) => {
        ...
        setDocument = Sizzle.setDocument = node => {
            ...
            support.getElementsByClassName = assert(div => {
            ...
            // Class
            Expr.find["CLASS"] = support.getElementsByClassName && ((className, context) => {
        ...
        Sizzle.attr = (elem, name) => {
            ...
            var // Don't get fooled by Object.prototype properties (jQuery #13807)
            ...
            filter: {
                ...
                "TAG": function( nodeNameSelector ) {
                    ...
                    return nodeNameSelector === "*" ?
                        () => true :
                        elem => elem.nodeName && elem.nodeName.toLowerCase() === nodeName;
                },
        ...
        support.sortDetached = assert(div1 => // Should return 1, but returns 4 (following)
    ...
    function createOptions( options ) {
        ...
        jQuery.each( options.match( core_rnotwhite ) || [], (_, flag) => {
            object[ flag ] = true;
        });
        return object;
    }
        ...
        Deferred(func) {
					...
					return jQuery.Deferred(newDefer => {
						jQuery.each( tuples, (i, tuple) => {
							...
							deferred[ tuple[1] ](function(...args) {
								var returned = fn && fn.apply( this, args );
								if ( returned && jQuery.isFunction( returned.promise ) ) {
									...
									newDefer[ action + "With" ]( this === promise ? newDefer.promise() : this, fn ? [ returned ] : args );
								}
							});
						});
						fns = null;
            ...
            jQuery.each( tuples, (i, tuple) => {
                ...
                deferred[ tuple[0] ] = function(...args) {
                    deferred[ tuple[0] + "With" ]( this === deferred ? promise : this, args );
                    return this;
                };
    ...
    jQuery.support = ((support => {
        ...
        jQuery(() => {
            ...
            var // Support: Firefox, Android 2.3 (Prefixed box-sizing versions).
    ...
    */
    ...
    Data.accepts = owner => // Accepts only:
    //  - Node
    //    - Node.ELEMENT_NODE
    //    - Node.DOCUMENT_NODE
    //  - Object
    ...
    Data.prototype = {
        key(owner) {
            ...
            var // Check if the owner object already has a cache key
        ...
        set(owner, data, value) {
            ...
            var // There may be an unlock assigned to this node,
    ...
    jQuery.each( jQuery.expr.match.bool.source.match( /\w+/g ), (i, name) => {
        ...
        jQuery.expr.attrHandle[ name ] = (elem, name, isXML) => {
    ...
    jQuery.each([ "radio", "checkbox" ], function() {
        ...
        if ( !jQuery.support.checkOn ) {
            jQuery.valHooks[ this ].get = elem => // Support: Webkit
    ...
    function winnow( elements, qualifier, not ) {
        if ( jQuery.isFunction( qualifier ) ) {
            return jQuery.grep( elements, (elem, i) => /* jshint -W018 */
        ...
        return jQuery.grep( elements, elem => ( core_indexOf.call( qualifier, elem ) >= 0 ) !== not);
    }
    ...
    var // We have to close these tags to support XHTML (#13200)
    wrapMap = {
    ...
    jQuery.fn.extend({
        ...
        append(...args) {
            return this.domManip( args, function( elem ) {
        ...
        replaceWith() {
            ...
            args = jQuery.map( this, elem => [ elem.nextSibling, elem.parentNode ]);
        ...
        domManip(args, callback, allowIntersection) {
            // Flatten any nested arrays
    ...
    jQuery.fn.extend({
        css(name, value) {
            return jQuery.access( this, (elem, name, value) => {
                var styles;
                var len;
                var map = {};
                var i = 0;
    ...
    if ( jQuery.expr && jQuery.expr.filters ) {
        jQuery.expr.filters.hidden = elem => // Support: Opera <= 12.12
    ...
    jQuery.extend({
        ...
        ajax(url, options) {
            ...
            var // URL without anti-cache param
            cacheURL;
            ...
            var // Context for global events is callbackContext if it is a DOM node or jQuery collection
